...
/*
  ...
  "MONTJUIC PER MIRAMAR" o "subida a montjuic". Pero un nombre ya bien
  escrito no se toca: reformatearlo solo puede estropearlo, porque no
  hay forma de saber que "Miramar" es un nombre propio sin un
  diccionario de toponimos. Solo se recasan los que vienen claramente
  mal, es decir enteros en mayusculas o enteros en minusculas.
*/
export function normalizarNombre(nombre) {
  ...
  /* Ya viene con mayusculas y minusculas mezcladas: alguien lo escribio
     con criterio. Solo se asegura que arranque en mayuscula. */
