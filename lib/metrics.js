...
/*
  ...
  Calibrado contra puertos conocidos: Angliru (12,5 km al 10,1 %) da
  1275 y Mortirolo (12,4 km al 10,5 %) da 1367, ambos HC. La escala se
  queda algo corta arriba (Tourmalet sale 1a siendo HC), asi que peca de
  prudente antes que de generosa.
*/
export const CATEGORIAS_PUERTO = [
  { codigo: '4a', nombre: '4ª cat', hasta: 200, color: '#5BA85B' },
  { codigo: '3a', nombre: '3ª cat', hasta: 350, color: '#4A90D9' },
  { codigo: '2a', nombre: '2ª cat', hasta: 650, color: '#E0C020' },
  { codigo: '1a', nombre: '1ª cat', hasta: 1200, color: '#E07B2E' },
