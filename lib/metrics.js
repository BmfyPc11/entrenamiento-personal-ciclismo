...
/*
  ...
  interseccion sobre union, igual criterio que ya usa emparejarSegmento en
  nombres.js para decidir si un segmento de Strava y una subida detectada
  hablan de lo mismo. Aqui sirve para lo contrario: decidir si un puerto
  detectado automaticamente es en realidad el mismo tramo que ya esta
  marcado a mano, para no contarlo dos veces (una en "Mis ascensiones" o
  en "Detalles de la ruta" con su nombre automatico, y otra en "Mis
  segmentos" con el nombre que de verdad le ha puesto el usuario).
*/
