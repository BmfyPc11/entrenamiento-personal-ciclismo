...
/*
  ...
  caia en 4a y la etiqueta no distinguia nada: una subida de 3,7 km al
  7,2 % y un repecho de 600 m al 6,5 % salian iguales. Bajando los
  umbrales, esa misma salida reparte sus subidas entre 4a, 3a y 2a, que
  es justo para lo que sirve categorizar.

  De propina, los puertos grandes encajan mejor que con la escala
  anterior: Tourmalet y Alpe d'Huez pasan a HC, que es lo que son.
*/
export const CATEGORIAS_PUERTO = [
  { codigo: '4a', nombre: '4ª cat', hasta: 75, color: '#5BA85B' },
  { codigo: '3a', nombre: '3ª cat', hasta: 150, color: '#4A90D9' },
  { codigo: '2a', nombre: '2ª cat', hasta: 300, color: '#E0C020' },
  { codigo: '1a', nombre: '1ª cat', hasta: 600, color: '#E07B2E' },
  ...
  for (const s of val) {
    ...
    for (const tr of dureza.tramos) {
      ...
      const g = grupos[clave] || (grupos[clave] = {
        terreno, zona, metros: 0, segundos: 0, sumaFC: 0, nFC: 0,
      });
      g.metros += metros;
      g.segundos += seg;
      g.sumaFC += sumaFC;
